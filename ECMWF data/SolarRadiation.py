...
fyle =   open(date +'_01/solarradiation.csv')
...
##### i seriously dont know why 97:193 is working even when the new date starts at 100, but this file is giving the correct results.
